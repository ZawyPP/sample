...
public class FirebaseToSQLite {
    ...
    public FirebaseToSQLite(Context context, final String TABLE, Map object) {
    ...
    private void copyEvents(Map <String,Object>mapObjects) {
        ...
        for(Map.Entry mapObject : mapObjects.entrySet()){
            ...
            cv.put(COLUMN_EVENT_NAME,(String)map.get(COLUMN_EVENT_NAME));
            cv.put(COLUMN_EVENT_TIME,(String)map.get(COLUMN_EVENT_TIME));
    ...
    private void copyBook(Map <String,Object>mapObjects) {
        ContentValues cv = new ContentValues();
        Map<String,Object> map=null;
        for(Map.Entry mapObject : mapObjects.entrySet()){
    ...
    private void copyDailyMenu(Map <String,Object>mapObjects) {
        ContentValues cv = new ContentValues();
        Map<String,Object> map=null;
        for(Map.Entry mapObject : mapObjects.entrySet()){
            ...
            cv.put(COLUMN_CREATED, TextEdit.notNull((String)map.get(COLUMN_CREATED)));
            cv.put(COLUMN_UPDATED, TextEdit.notNull((String)map.get(COLUMN_UPDATED)));
            db.getWritableDatabase().insert(TB_MENU, COLUMN_CREATED, cv);
    ...
    private void copyTexts(Map <String,Object>mapObjects) {
        ContentValues cv = new ContentValues();
        Map<String,Object> map=null;
        for(Map.Entry mapObject : mapObjects.entrySet()){
