...
public class TaskSum extends AsyncTask<Object,Boolean,Void> {
    ...
    public TaskSum(View view, String TABLE) {
        ...
        if(networkStatus.isConnected()) {
            ...
            switch (TABLE) {
                case TB_EVENTS:
                    ...
                    try {
                         vacancies = Integer.parseInt(event.getCapacity()) - db.getCount();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
